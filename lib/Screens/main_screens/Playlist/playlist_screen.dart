                                ...
                                child: SizedBox(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      children: [
                                        Image.asset(
                                            'assets/Image/gifgit-unscreen.gif',
                                            width: 250,
                                            height: 250),
                                        const Text(
...
Future<dynamic> editPlaylistName(
  ...
  return showDialog(
    ...
    builder: (ctx) => SimpleDialog(
      ...
      backgroundColor: const Color.fromARGB(255, 165, 113, 223),
      children: [
        SimpleDialogOption(
          child: Text(
...
Future<dynamic> deletePlaylist(
  ...
  return showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        backgroundColor: const Color.fromARGB(255, 157, 119, 202),
        title: const Text(
          'Delete Playlist',
...
Future newplaylist(BuildContext context, formKey) {
  return showDialog(
    ...
    builder: (ctx) => SimpleDialog(
      ...
      backgroundColor: const Color.fromARGB(255, 147, 108, 190),
      children: [
